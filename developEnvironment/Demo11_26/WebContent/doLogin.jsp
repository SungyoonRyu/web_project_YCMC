		...
		<div id="loginSection" class="loginBox">
			<div id="loginSectionInside" class="loginBox">
				<form method="post" action="login">
					<ul>
						<li><label>ID<input type="text" name="userID" placeholder="아이디를 입력하세요." required></label></li>
						<li><label>PASSWORD<input type="password" name="userPassword" placeholder="비밀번호를 입력하세요." required></label></li>
					</ul>
