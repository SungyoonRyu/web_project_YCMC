		...
		<div id="seePostBackDiv">
            <div id="firstDiv">
                <div id="seePostLabelDiv">
                    <div id="ManuButton">
                    <% if(session.getAttribute("nickname") != null) { if(session.getAttribute("nickname").equals(PostDTO.getUserNickname())) { %>
                        <a href="editMyPost.jsp?id=<%= PostDTO.getBoardID() %>">수정</a>
                        <a href="deleteMyPost?id=<%= PostDTO.getBoardID() %>" style="background-color:rgb(231, 76, 60);">삭제</a>
                    <% }} %>
                    </div>
                    <img src="images/profileimage/<%= session.getAttribute("ID") %>IMG.jpg"></img>
			...
			<hr class="seeposthr">
			<div id="secondDiv">
				<p><%= PostDTO.getUserNickname() %>님의 옷 정보</p>
			...
			<div id="thirdDiv">
				...
				<table class="infoTable">
					<tbody>
						...
						<tr>
							<th>대여 횟수</th>
							<td colspan="2"><%= PostDTO.getRentalCount() %>회</td>
						</tr>
						<tr>
							<th>대여 기간</th>
