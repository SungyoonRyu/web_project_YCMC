							...
							<tr>
								...
								<td>
									<select name="postCategory" required>
										...
										<option value="top" <% if(DTO.getCategory().equals("top")) out.print("selected"); %>>상의</option>
										<option value="bottoms" <% if(DTO.getCategory().equals("bottoms")) out.print("selected"); %>>하의</option>
										<option value="shoes" <% if(DTO.getCategory().equals("shoes")) out.print("selected"); %>>신발</option>
										<option value="accessory" <% if(DTO.getCategory().equals("accessory")) out.print("selected"); %>>악세사리</option>
										<option value="bag" <% if(DTO.getCategory().equals("bag")) out.print("selected"); %>>가방</option>
										<option value="etc" <% if(DTO.getCategory().equals("etc")) out.print("selected"); %>>기타</option>
									</select>
								</td>
							</tr>
							<tr>
