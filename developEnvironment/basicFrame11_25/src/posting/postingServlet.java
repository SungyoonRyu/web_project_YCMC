...
public class postingServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String saveDir = "C:\\Users\\mookm\\workspace\\ProjectWeb\\WebContent\\images\\imageboard";
		...
		if(!boardID.equals("")) {
		    ...
		    if(uploadFile.exists()) {     // �뾽濡쒕뱶�맂 �뙆�씪紐낆씠 議댁옱�븯硫� Rename�븳�떎.
		    	File newFile = null;
		         do {
		        	 j++;
		...
		response.getWriter().append((String)multi.getParameter("rentalFromDate")).append(Boolean.toString(isPostUp)).append((String)session.getAttribute("nickname"));
	}
