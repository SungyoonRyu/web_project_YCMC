...
<script type="text/javascript">
	...
	function passwordcheck(){
		...
		if(newPassword!=newPassword2){
			$("#confirmPW").html("비밀번호 일치하지 않습니다.");
		}else{
			$("#confirmPW").html("비밀번호 일치합니다.");
		}
	}
</script>
			...
			<div id="loginSectionInside" class="signin">
				...
				<div style="display:inline-block;padding-left: 12px;">
					<ul>
						...
						<input style="font-size:16px;" id="userPassword"type="password" name="userPassword" placeholder="비밀번호를 입력하세요" maxlength="12" required></label></li>
						<li><label>비밀번호 확인
						<input style="font-size:16px;" id ="confirmPassword" type="password" name="confirmPassword" onkeyup="passwordcheck()" placeholder="비밀번호를 다시 한 번 입력하세요" maxlength="12" required></label></li>
