...
<body>
	...
	<div id="container">
		...
		<div id="loginSection" class="editmyProfile">
			<div id="loginSectionInside" class="editmyProfileInside">
				<form method="post" action="changeProfile">
					<ul>
						<li><label>아이디<span>&nbsp&nbsp #아이디는 변경이 불가능합니다</span></label>
						...
						<li><label>Email<span>&nbsp&nbsp #이메일은 변경이 불가능합니다</span><input style="font-size:16px;" type="text" name="userEmail" value="<%= DTO.getUserEmail() %>" readonly></label></li>
						<li>
							<fieldset class="sexSelectField" action="" method="post">
								<legend>성별</legend>
								<ul>
